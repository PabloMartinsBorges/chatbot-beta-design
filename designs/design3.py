...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        tk.Label(self, text="NUGEP\n Bot", font="Courier 20").grid(row=0, column=0)
    ...
    # Button
        ...
        self.radio_frame.grid(row=3, column=0, padx=(20, 10), pady=10, sticky="nsew")
        ...
        self.paned.grid(row=0, column=1, pady=(10, 5), sticky="nsew", rowspan=4)
        ...
        self.conversa = tk.Text(self.pane_1, width=60, height=30, font='Arial 10', relief='groove')
        ...
        self.conversa.pack(fill='both', expand='yes', padx=10, pady=5)
        self.conversa.config()
       ...
       # self.label = ttk.Label(
        ...
        self.entry.grid(row=2, column=0, padx=10, pady=(0, 10), columnspan=3)
